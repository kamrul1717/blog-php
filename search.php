 ...
 ?>
        ...
        <!--Pagination-->
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                   <?php 
            $query = "SELECT * FROM tbl_post WHERE title LIKE '%$search%' OR body LIKE '%$search%' order by id desc limit $start_form,$per_page";
            ...
            while ($result = $post->fetch_assoc()) {
                ...
                $submit = 'submit';
                echo "<ul class='pagination pagination-lg'><li><a href='".SITE_URL."search.php?search=".$search."&submit=".$submit."&page=1'><i class='icon-angle-left'></i>".''."</a></li>" ;
                for ($i=1; $i <= $total_pages ; $i++) { 
                    $active = $i == $page ? 'class="active"' : '';
                    echo "<li $active><a href='".SITE_URL."search.php?search=".$search."&submit=".$submit."&page=".$i."'>".$i."</a></li>";
                }
                echo "<li><a href='".SITE_URL."search.php?search=".$search."&submit=".$submit."&page=$total_pages'>".''."<i class='icon-angle-right'></i></a></li></ul>"; } ?>
